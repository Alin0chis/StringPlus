...
START_TEST(test_many_hex_lower_with_and_hashtag) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
...
START_TEST(testmanyhexlowerwithprecisionandother) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  int a = s21_sprintf(
...
Suite *suite_sprintf(void) {
  ...
  tcase_add_test(tc, test_many_hex_lower_with_and_hashtag);
  ...
  tcase_add_test(tc, testmanyhexlowerwithprecisionandother);
